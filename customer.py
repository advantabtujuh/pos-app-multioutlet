...
class FormCustomerDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("✏️ Edit Data Customer" if is_edit else "➕ Tambah Customer Baru")
        self.setModal(True)
        self.resize(420, 380)
        ...
        self.input_kode.setPlaceholderText("Kode unik customer")
        self.input_kode.setStyleSheet(self._input_style())

        self.input_nama = QLineEdit(self)
        self.input_nama.setPlaceholderText("Nama lengkap customer")
